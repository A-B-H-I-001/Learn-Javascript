...
console.log(marks);
marks.unshift(24) //adding in the first
console.log(marks);
console.log(marks.indexOf(20)) //find on which index
...
//filter har ek element ko check karta hai.....
const studentMarks = [24,20,24,68,10];
const filteredMarks = studentMarks.filter((num,index) => num < 25); //create new array
console.log(studentMarks);
console.log(filteredMarks);

//map har ek element pe chlta hai...
const gradedMarks = studentMarks.map((num) => num/4);
console.log(gradedMarks);
